...
The variables tested in the model are payroll, cocscode, division, gender, years of service at hired, age at start, policy, P85 (binary indicator of 85 retirement points) and the interaction term of P85 and A65 (A65 is not estimable in the Cox PH model). Gender, payroll, and cocscode are not significant in the Cox PH model. These indicates employees' gender, job types, or working full time or part time are not the influential factors of employees retirement. The statistically influential factors are division, years of service at hired, age at start, policy, P85 and the interaction term of P85 and A65 in the Cox PH model as shown in the table \ref{tab:paraest.}. The reference levels of these variables are division 1, policy at 0, P85 at 0, P85*A65 at 0, 2.75 years of service at hired and 45.59 years of age. Division 1 is the reference group with hazard ratio as 1. Three divisions (2, 3, and 9) have negative estimates (-0.969, -0.239, and -3.026) and the hazard ratios lower than 1 (0.380, 0.788, and 0.049). The survival probabilities for the employees in these division are $S(t)^{0.380}, S(t)^{0.788}$, and $S(t)^{0.049}$ adjusting for the other variables, where $S(t)$ is the baseline function or the survival probability for the employee of division 1 at time t. The division 9 have the lowest hazard ratio, which indicates the employee in division 9 are much less likely to retire than division 1. Three divisions (6, 7 and 8) have positive estimates (2.124, 2.434, and 2.360). Two divisions (division 6 and 7) have very high hazard ratio: 8.363 and 11.405. The survival probability for the employee in these two division are $S(t)^{8.363}$ and $S(t)^{11.405}$ adjusting for the other variables, which indicates that the employee in division 6 and division 7 are much more likely to retire than the employee in division 1. The other divisions (4 and 5) are not statistically significant, which indicates that the employee in division 4 and 5 has the similar chance to retire with the employee in the division 1.

\item Retirement can also be influenced by employee's age and their year of service when they at hire.
...
\item  P85 and A65's impact on the data.  Explain why interaction is useful.

85 Points and age at 65 are two alternative retirement requirements for the employee to get pension in the organization. The 85 points and age at 65 are also tested as two key impactors on retirement. P85 as a dummy variable has positive estimates (1.531) and hazard ratio of 4.623 when P85 is equal to 1. The survival probability of the employee with 85 points and less than 65 years old is $S(t)^{4.623}$, compared to the employee who does not reach 85 points ($S(t)$), which indicates that the employee who are much more likely to retire when they reach 85 points requirement. The interaction term of P85 and A65 are also statistically significant in the model with negative estimates (-1.590). This means the employee who reaches 85 points and also older than 65 years has hazard ratio 0.943 ($e^{1.531-1.590}$). The survival probability is $S(t)^{0.943}$ for the employee who are eligible for both retirement requirements, which indicates this kind of employees are less likely to retire. Notice that the hazard ratio is 1 for the employee who does not reach 85 points, no mater they are younger or older than 65 years old. The interaction term shows that the retiring behavior changes for three periods: the employee is not eligible for retirement,  when the one reaches 85 points, and when they are eligible for two requirements.  

\item Policy's impact. 
  
The HR buyout policy also has pivot impact on employee retirement as shown from the model estimates. The estimates of policy effect is 1.252 and 3.496 of hazard ratio. It shows that the buyout policy cause the employee's survival probability down to $S(t)^{3.496}$, compare to without the policy impact. Therefore, buyout policy have stronger effect on forcing the employee to retire than without the policy. 
