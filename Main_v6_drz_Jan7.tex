...
\begin{table}[h!]
	...
	\scriptsize
	\smallskip
	\caption{Retirement Predictions by Occupational Code (COCS) without external variables}
	\begin{threeparttable}
...
\subsection{Models for Retirement with External Economic Variables}
   ...
   \begin{table}[h!]
   		...
   		\scriptsize
   		\smallskip
   		\caption{Retirement Predictions by Occupational Code (COCS) with External Variable.}
   		\begin{threeparttable}
   			\begin{tabular}{cL{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}l}
   				\toprule
   				Year  &  Crafts & Engineers& General Admin. & Laborers& Managers& Prof. Admin.& Operators& Scientists& Technicians& Total \\
...
\begin{table}[h!]
	...
	\scriptsize
	\smallskip
	\caption{Voluntary Quitting Predictions by Occupational Code (COCS) with External Variables}
	\begin{threeparttable}
		\begin{tabular}{cL{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}L{1.2cm}l}
			\toprule
			Year  &  Crafts & Engineers& General Admin. & Laborers& Managers& Prof. Admin.& Operators& Scientists& Technicians& Total \\
