...
Finally, for comparison purposes we include a time series prediction model discussed in \cite{Zhu2016}.[MORE DETAILS ON TYPE OF MODEL, NUMB PARAMETERS ETC.]  The model produces an aggregate forecast by year and hence uses only 10 training points leading to a very accurate MAPE on the training data but much poorer performance out of sample.
